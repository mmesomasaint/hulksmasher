...
function Contact() {
  ...
  return (
    <div className='relative px-5 xs:px-16 md:px-20 xl:px-40 pt-96 py-10 bg-zinc-100 w-full'>
      <div className='absolute w-fit inset-x-0 mx-auto z-10 -top-60 md:top-20 mx-[2%] lg:mx-0 p-5 xs:p-10 rounded-md bg-amber-500/10 shadow-[0_0_20px_-6px_rgb(239_68_68_/_0.55)]'>
