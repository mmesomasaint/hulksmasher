            ...
            <div className='flex justify-center items-center h-full'>
              <div className='w-full h-fit pt-32 text-center'>
                <h1 className='block w-[90%] sm:w-[70%] lg:w-[60%] xl:w-[50%] mx-auto text-4xl md:text-6xl font-bold leading-loose text-white mb-4'>
                  Your Stop For&nbsp;
                  <span className='text-primary'>Custom-Made</span>
                ...
                <p className='block w-[90%] sm:w-[80%] md:w-[70%] lg:w-[50%] xl:w-[40%] mx-auto text-lg md:text-xl lg:text-base font-normal leading-tight text-white mb-8'>
                  Imagine the feeling of slipping into a pair of shoes or
                  wearing a garment that was meticulously crafted just for you.
                  It's a feeling of unparalleled comfort, style, and
                  self-expression. That's precisely the experience we strive to
                  create at Hulksmasher
                </p>
